...
describe("WebdriverIO and Appium, when using swiping", () => {
    ...
    it("should be able to swipe horizontal by swiping the carousel from left to right", async () => {
         ...
         */
        await expect(
            await Carousel.isCardActive(await Carousel.openSourceCard),
        ).toBeTruthy();
        ...
        await expect(
            await Carousel.isCardActive(await Carousel.communityCard),
        ).toBeTruthy();

        await Carousel.swipeLeft();
        await expect(
            await Carousel.isCardActive(await Carousel.jsFoundationCard),
        ).toBeTruthy();

        await Carousel.swipeLeft();
        await expect(
            await Carousel.isCardActive(await Carousel.supportVideosCard),
        ).toBeTruthy();

        await Carousel.swipeLeft();
        await Carousel.swipeLeft();
        await expect(
            await Carousel.isCardActive(await Carousel.compatibleCard),
        ).toBeTruthy();
        ...
        await expect(
            await Carousel.isCardActive(await Carousel.extendableCard),
        ).toBeTruthy();
